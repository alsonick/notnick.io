...
export const ProjectCard = (props: Project) => {
  ...
  return (
    <div className="rounded-2xl flex flex-col dark:bg-[#10161a]/50 bg-white border border-teal-100 dark:border-teal-900 sm:hover:border-primary sm:dark:hover:border-primary duration-300 w-full">
