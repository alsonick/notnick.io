  ...
  return (
    <main>
      ...
      <Article>
        ...
        <LinkTag href="https://www.typescriptlang.org/">TypeScript</LinkTag>{" "}
        &#38; <LinkTag href="https://reactjs.org/">React</LinkTag> and for the
        serverside I use <LinkTag href="https://nodejs.org/en/">Node</LinkTag>.
      </Article>
      <Article>
        I&apos;m also very passionate about systems programming and networking,
        recently I&apos;ve been picking up the{" "}
        <LinkTag href="https://www.rust-lang.org/">
      ...
      <Article>
        ...
        <LinkTag href="https://en.wikipedia.org/wiki/One_Piece">
          One Piece
        </LinkTag>
        .
      </Article>
      ...
      <ContactText>
        ...
        <LinkTag href="https://twitter.com/heynickn">DM on Twitter</LinkTag>.
      </ContactText>
      <ContactText>
