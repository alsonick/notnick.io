...
export const CommunityCard = () => {
  return (
    <div
      ...
      border border-teal-100 dark:border-teal-900 sm:hover:border-[#4752C4] sm:dark:hover:border-[#7984F5] duration-300 z-10
      ...
      <div className="relative z-10 flex sm:flex-row flex-col items-center w-full justify-between">
        <div className="flex mb-4 sm:flex-row flex-col items-center sm:mb-0">
          ...
          <div className="flex sm:ml-8 ml-0 flex-col sm:text-left mt-5 sm:mt-0 text-center">
            <span className="text-[0.65rem] font-semibold uppercase tracking-[0.15em] text-[#4752C4] dark:text-[#7984F5]">
              Discord Community
            </span>
