import { FULL_NAME, MAIN_CONTENT_ID, PROFESSION } from "../../lib/constants";
...
export const E = (props: Props) => {
  ...
  return (
    <>
      ...
      <main
        id={MAIN_CONTENT_ID}
        className="flex flex-col items-center justify-center w-screen h-screen px-6"
      >
        {enabled ? (
          <picture>
            <img
          ...
          !isEasterEgg && (
            <div className="flex flex-col items-center max-w-md">
              {props.subtitle && (
                <h1 className="text-4xl font-semibold text-center tracking-tight text-gray-800 dark:text-gray-200 mb-3">
                  {props.code}
