...
export const WALKING_FOR_100_DAYS: Content[] = [
  ...
  {
    id: generateRandomId(),
    description: "Yet another walking day, feeling great! :D",
    slug: "walking-for-100-days",
    completed: true,
    preview: {
      available: true,
  ...
  {
    id: generateRandomId(),
    description: "Felt like I've done more steps than this lol.",
    slug: "walking-for-100-days",
    completed: true,
    preview: {
      available: true,
  ...
  {
    id: generateRandomId(),
    description: "Forgot to take a screenshot but I did around 6-7K steps.",
    slug: "walking-for-100-days",
    completed: true,
    preview: {
      available: false,
  ...
  {
    id: generateRandomId(),
    description: "Leg day + long walk. My legs are KILLING me!",
    slug: "walking-for-100-days",
    completed: true,
    preview: {
      available: true,
  ...
  {
    id: generateRandomId(),
    description: "Rest day so I didn't do that many steps today.",
    slug: "walking-for-100-days",
    completed: true,
    preview: {
      available: true,
  ...
  {
    id: generateRandomId(),
    description: "Today I felt lazy so I didn't get much steps in.",
    slug: "walking-for-100-days",
    completed: true,
    preview: {
      available: true,
  ...
  },
  {
    id: generateRandomId(),
    description:
      "Could've gotten more steps in but at least I was able to hit back today!",
    slug: "walking-for-100-days",
    completed: true,
    preview: {
      available: true,
  ...
  {
    id: generateRandomId(),
    description: "Could've done better tbh.",
    slug: "walking-for-100-days",
    completed: true,
    preview: {
      available: true,
  ...
  {
    id: generateRandomId(),
    description: "I was absolutely lazy this day!",
    slug: "walking-for-100-days",
    completed: true,
    preview: {
      available: true,
  ...
  {
    id: generateRandomId(),
    description: "Felt like shit today so I had to rest it out.",
    slug: "walking-for-100-days",
    completed: true,
    preview: {
      available: true,
