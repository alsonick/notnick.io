...
export const EXPERIENCE: Experience[] = [
  ...
  },
  {
    ...
    startMonth: "jun",
    endMonth: "jul",
    logo: `${page.experience.path}/logo/PennElcom.jpg`,
    employmentType: "apprenticeship",
    location: "Hastings, England - United Kingdom",
    remote: false,
    current: false,
    link: "https://www.penn-elcom.com/",
    task: "Completed a one-week work experience placement at Penn Elcom, gaining an insight into how different departments work together and how the business operates.",
    filter: "Engineering",
    slug: "penn-elcom",
    discontinued: false,
    feature: true,
